...
class Instructor:
    ...
    def get_instructor_data(self):
        ...
        if not self.course_student.items():
            inst_list.append(
                [self.cwid, self.name, self.department, None, None])
        else:
...
class Major:
    ...
    def calc_major_grades(self, courses):
        ...
        return [list(completed_courses), required_remaining, electives_remaining]
...
def main():
    stevens = Repository(
        '/home/ankit/Desktop/Stevens/Semester 3/SSW-810/Assignments/HW10')
